...
dfGDP |> na.omit() |>
  ...
  scale_fill_manual(values = c("North America" = "#000000", "Asia" = "#C4AD9D", "South America" = "#0274BD", "Europe" = "#F57251")) +
  labs(
    x = "GDP per Capita",
    y = "",
    color = "Subregion",
    ...
    subtitle = glue::glue(
      ...
      <span style = 'color: #000000;'><b>North America</b></span>,
      <span style = 'color: #0274BD;'><b>South America</b></span>.
      "
    )
  ) +
  theme(
